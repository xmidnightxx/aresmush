module AresMUSH
  ...
  class Bootstrapper 
    ...
    def initialize
      ...
      @@addon_manager = AddonManager.new(game_dir)
      ...
      @@addon_manager.container = Container.new(config_reader, client_monitor, @@addon_manager, dispatcher)
